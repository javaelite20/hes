...
import org.smarttech.mqtt.MqttMessageHandler;
...
public class MqttConfig {
    ...
    @Value("${mqtt.topic.meter-reading}")
    ...
    public MqttPahoMessageDrivenChannelAdapter mqttInbound() {
        MqttPahoMessageDrivenChannelAdapter adapter =
                new MqttPahoMessageDrivenChannelAdapter(clientId, mqttClientFactory(), meterReadingTopic);
