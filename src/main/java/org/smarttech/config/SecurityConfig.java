package org.smarttech.config;

import lombok.RequiredArgsConstructor;
import org.smarttech.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    // Comma-separated allowed origins from config — e.g. "http://localhost:3000,https://app.yourdomain.com"
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Origins — driven by config, no hardcoding
        ...
        // Cache preflight response for 1 hour — reduces OPTIONS noise
